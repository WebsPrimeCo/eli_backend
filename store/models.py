...
class Product(models.Model):
    ...
    available_colors = models.ManyToManyField('Color', blank=True, related_name='product_color')
    available_size = models.ManyToManyField('Size', blank=True, related_name='product_size')
